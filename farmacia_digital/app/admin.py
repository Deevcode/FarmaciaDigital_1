...
from .models import Region, Provincia, Comuna, Laboratorio, Principio, Farmacia, FarmaciaSucursal, Medicamentos, MedicamentosDescuento, Usuario, UsuarioReceta, UsuarioFarmacoVigilancia, Contacto #MedicamentoFichaTecnica
...
#    list_display = ["id_medicamento_ficha_tecnica", "nombre_comercial", "id_medicamento", "url_ficha"]
#    search_fields = ["id_medicamento_ficha_tecnica", "nombre_comercial", "id_medicamento", "url_ficha"]
...
#admin.site.register(MedicamentoFichaTecnica)
